...
pub(super) static DELETION_THREAD: OnceLock<std::thread::Thread> = OnceLock::new();
...
pub(super) static SWEEP_REQUEST_EPOCH: std::sync::atomic::AtomicU64 = std::sync::atomic::AtomicU64::new(0);
pub(super) static SWEEP_COMPLETE_EPOCH: std::sync::atomic::AtomicU64 = std::sync::atomic::AtomicU64::new(0);
